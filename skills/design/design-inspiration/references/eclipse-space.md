---
source: https://www.eclipse.space
captured: 2026-09-11
...
- The condensed display type, supporting novelty faces, the satellite imagery, and the wordmark. Those are identity.
- Treating the spacing dump as a token set. It is leftover from a filmic layout.
- Full-viewport cinematic motion as a default. It suits this audience staring at hardware; it is wrong for operators scanning a table.
- Treating "almost no UI" as a brief for an application. This is a marketing still, not a product surface.

## Not applicable here

- Store-only pass. Apply when a product is named. Cinematic B2B is the wrong reference for a records list, a form, or an accessibility-critical service.
